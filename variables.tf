...
variable "ssh_keys" {
  ...
  default = [
    ...
    # anton@status.im
    "no-touch-required sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIMSh3b/H1cNyXvcMoK0YgtkEdTbXe+gXVMPggwgwAIBNAAAABHNzaDo= yakimant@gmail.com",
    "no-touch-required sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIMhMWYbBBLGQb7eTogLIyevWslPlKXPfIYGNzKal3tsfAAAABHNzaDo= yakimant@gmail.com",
    # marko@status.im
